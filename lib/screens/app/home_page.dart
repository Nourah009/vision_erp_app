...
Widget _buildVisionERPSection(BuildContext context) {
  return Container(
    width: double.infinity, // This will now take the constrained width from Padding
    padding: EdgeInsets.all(_responsiveValue(
      context,
      mobile: 16,
      tablet: 20,
    ...
    child: Column(
      ...
      children: [
        ...
        // Divider line
        Container(
          margin: EdgeInsets.symmetric(vertical: _responsiveValue(
            context,
            mobile: 12,
            tablet: 14,
            desktop: 16,
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        SizedBox(height: _responsiveValue( // Increased space between text and boxes
          context,
          mobile: 24,
          tablet: 28,
          desktop: 32,
...
Widget _buildPlanCard(BuildContext context, Map<String, dynamic> plan) {
  return Container(
    ...
    decoration: BoxDecoration(
      border: Border.all(
        color: plan['isPopular'] ? AppColors.primaryColor : AppColors.primaryColor.withOpacity(0.2),
