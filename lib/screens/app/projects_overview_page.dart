...
class ProjectsOverviewPage extends StatelessWidget {
              ...
              children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(
                        isEnglish ? 'Projects Management' : 'إدارة المشاريع',
                        style: TextStyle(
                          fontFamily: 'Cairo',
                          fontSize: 28,
                          fontWeight: FontWeight.bold,
                      ...
                      Text(
                        isEnglish ? 'Planning & Execution System' : 'نظام التخطيط والتنفيذ',
                        style: TextStyle(
                          fontFamily: 'Cairo',
                          fontSize: 16,
      ...
      children: [
        Row(
          children: [
            ...
            Text(
              isEnglish ? 'Projects System Overview' : 'نظرة عامة على نظام المشاريع',
              style: TextStyle(
                fontFamily: 'Cairo',
  ...
  Widget _buildFeaturesList(BuildContext context, bool isEnglish, double screenWidth) {
    final features = isEnglish
        ? [
            {'icon': Icons.task_alt, 'text': 'Task & Milestone Management'},
            {'icon': Icons.group, 'text': 'Team Collaboration & Communication'},
            {'icon': Icons.pie_chart, 'text': 'Project Dashboards & Analytics'},
            {'icon': Icons.account_balance_wallet, 'text': 'Budget & Cost Control'},
            {'icon': Icons.timeline, 'text': 'Timeline & Schedule Management'},
            {'icon': Icons.analytics, 'text': 'Progress Tracking & Reporting'},
          ]
        : [
            {'icon': Icons.task_alt, 'text': 'إدارة المهام والمعالم'},
            {'icon': Icons.group, 'text': 'التعاون والتواصل بين الفريق'},
            {'icon': Icons.pie_chart, 'text': 'لوحات تحكم وتحليلات المشاريع'},
            {'icon': Icons.account_balance_wallet, 'text': 'التحكم بالميزانية والتكاليف'},
            {'icon': Icons.timeline, 'text': 'إدارة الجدول الزمني'},
            {'icon': Icons.analytics, 'text': 'تتبع التقدم وإعداد التقارير'},
          ];
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: screenWidth > 600 ? 16 : 12),
              Text(
                isEnglish ? 'Project Metrics' : 'مقاييس المشاريع',
                style: TextStyle(
                  fontFamily: 'Cairo',
                  fontSize: screenWidth > 600 ? 22 : 18,
                  fontWeight: FontWeight.bold,
          ...
          Wrap(
            ...
            children: [
              _buildStatItem(
                context,
                isEnglish ? 'Active Projects' : 'المشاريع النشطة',
                '18',
                Colors.teal,
                screenWidth,
              ),
              _buildStatItem(
                context,
                isEnglish ? 'On Schedule' : 'وفق الجدول',
                '14',
                Colors.green,
                screenWidth,
              ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  isEnglish ? 'Overall Completion Rate' : 'معدل الإنجاز الكلي',
                  style: TextStyle(
                    fontFamily: 'Cairo',
        ...
        children: [
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                isEnglish ? 'Create Project' : 'إنشاء مشروع',
                style: TextStyle(
                  fontFamily: 'Cairo',
                  fontSize: fontSize,
                  fontWeight: FontWeight.w600,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isEnglish
                ? 'Login is required to access full project management features including project creation, task assignment, team collaboration, budget management, and detailed project reporting.'
                : 'يتطلب تسجيل الدخول للوصول إلى جميع ميزات إدارة المشاريع بما في ذلك إنشاء المشاريع، وتعيين المهام، والتعاون بين الفريق، وإدارة الميزانية، وتقارير المشاريع التفصيلية.',
            style: TextStyle(
              fontFamily: 'Cairo',
              fontSize: screenWidth > 600 ? 15 : 14,
              color: Colors.grey[700],
