...
import 'package:vision_erp_app/screens/app/home_page_sections/demo_section/demo_system_page.dart';
import 'package:vision_erp_app/screens/app/dashboard_page.dart';
import 'package:vision_erp_app/screens/app/floating_message_button/floating_messages_button.dart';
import 'package:vision_erp_app/screens/app/login_page_section/login_page.dart';
import 'package:vision_erp_app/screens/app/notification_section/notification_dropdown.dart';
import 'package:vision_erp_app/screens/app/sidebar_menu_sections/notifications_page.dart';
...
import 'package:vision_erp_app/screens/app/sidebar_menu_sections/sidebar_menu.dart';
...
class _HomePageState extends State<HomePage> {
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              isEnglish ? 'Move towards a better future' : 'توجه نحو مستقبل أفضل',
              style: TextStyle(
                fontFamily: 'Cairo',
                fontSize: _responsiveValue(
                  context,
  ...
  Widget _buildSidebarMenu(BuildContext context) {
    return SidebarMenu(
      user: _currentUser,
      userName: _currentUser != null ? _currentUser!.username : isEnglish ? 'Welcome' : 'مرحباً',
      userRole: _currentUser != null ? _currentUser!.role : isEnglish ? 'to Vision ERP' : 'في تخطيط موارد المؤسسة',
      onMyAccountTap: () {
