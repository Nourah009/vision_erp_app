...
class QualityControlOverviewPage extends StatelessWidget {
  const QualityControlOverviewPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          isEnglish ? 'Quality Control' : 'مراقبة الجودة',
          style: TextStyle(
            fontFamily: 'Cairo',
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        isEnglish ? 'Quality Management System' : 'نظام إدارة الجودة',
                        style: TextStyle(
                          fontFamily: 'Cairo',
                          fontSize: 16,
      ...
      children: [
        Row(
          children: [
            ...
            Text(
              isEnglish ? 'Quality Control System Overview' : 'نظرة عامة على نظام مراقبة الجودة',
              style: TextStyle(
                fontFamily: 'Cairo',
  ...
  Widget _buildFeaturesList(BuildContext context, bool isEnglish, double screenWidth) {
    final features = isEnglish
        ? [
            {'icon': Icons.search, 'text': 'Inspection & Testing Management'},
            {'icon': Icons.analytics, 'text': 'Defect Analysis & Reporting'},
            {'icon': Icons.timeline, 'text': 'Compliance & Standards Tracking'},
            {'icon': Icons.build, 'text': 'Corrective & Preventive Actions'},
            {'icon': Icons.assessment, 'text': 'Quality Audits & Reviews'},
            {'icon': Icons.monitor_heart, 'text': 'Real-time Quality Monitoring'},
          ]
        : [
            {'icon': Icons.search, 'text': 'إدارة التفتيش والاختبار'},
            {'icon': Icons.analytics, 'text': 'تحليل العيوب وإعداد التقارير'},
            {'icon': Icons.timeline, 'text': 'تتبع الامتثال والمعايير'},
            {'icon': Icons.build, 'text': 'الإجراءات التصحيحية والوقائية'},
            {'icon': Icons.assessment, 'text': 'تدقيقات ومراجعات الجودة'},
            {'icon': Icons.monitor_heart, 'text': 'مراقبة الجودة الآنية'},
          ];
        ...
        children: [
          Row(
            children: [
              ...
              SizedBox(width: screenWidth > 600 ? 16 : 12),
              Text(
                isEnglish ? 'Quality Metrics' : 'مقاييس الجودة',
                style: TextStyle(
                  fontFamily: 'Cairo',
                  fontSize: screenWidth > 600 ? 22 : 18,
                  fontWeight: FontWeight.bold,
          ...
          Wrap(
            ...
            children: [
              ...
              _buildStatItem(
                context,
                isEnglish ? 'Defect Rate' : 'معدل العيوب',
                '1.3%',
                Colors.orange,
                screenWidth,
              ),
              _buildStatItem(
                context,
                isEnglish ? 'Inspections' : 'عمليات التفتيش',
                '245',
                Colors.blue,
                screenWidth,
              ),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  isEnglish ? 'Customer Satisfaction' : 'رضا العملاء',
                  style: TextStyle(
                    fontFamily: 'Cairo',
        ...
        children: [
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                isEnglish ? 'Create Inspection' : 'إنشاء تفتيش',
                style: TextStyle(
                  fontFamily: 'Cairo',
                  fontSize: fontSize,
                  fontWeight: FontWeight.w600,
          ...
          SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                isEnglish ? 'View Reports' : 'عرض التقارير',
                style: TextStyle(
                  fontFamily: 'Cairo',
                  fontSize: fontSize,
                  fontWeight: FontWeight.w600,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isEnglish
                ? 'Login is required to access full quality control features including inspection management, defect tracking, compliance monitoring, quality audits, and detailed quality reporting.'
                : 'يتطلب تسجيل الدخول للوصول إلى جميع ميزات مراقبة الجودة بما في ذلك إدارة التفتيش، وتتبع العيوب، ومراقبة الامتثال، وتدقيقات الجودة، وتقارير الجودة التفصيلية.',
            style: TextStyle(
              fontFamily: 'Cairo',
              fontSize: screenWidth > 600 ? 15 : 14,
              color: Colors.grey[700],
